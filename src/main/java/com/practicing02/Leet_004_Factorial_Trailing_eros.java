...
import com.leetcode.Leet_004_Factorial_Trailing_Zeroes;
 ...
 */
public class Leet_004_Factorial_Trailing_eros {
    ...
    public static void main(String[] args) {
        ...
        int thirdFive = Leet_004_Factorial_Trailing_eros.trailingZeroes(35);
...
//TODO get the explanation for trailing Zeros
        if (n < 5) return 0;
        int zeros = 0;
        int currentPowerOf = 5;
        while(currentPowerOf<= n){
            zeros += n / currentPowerOf;
            currentPowerOf *= 5;
        }
